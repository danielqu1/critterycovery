...
function CountryCard(props: cardProps) {
    let searchArray = props.searchVal.split(' ')

    const cardProperties = [
        {
            text: 'Population: ',
            highlightData: props.data.total_pop.toLocaleString(undefined),
        },
        {
            text: 'Capital: ',
            highlightData: props.data.capital,
        },
        {
            text: 'Region: ',
            hightlightData: props.data.region,
        },
        {
            text: 'Land Area (km^2): ',
            highlightData: props.data.area,
        }
    ]
        ...
        <Card 
            ...
            <Title level={5} style={{padding: 0,}}>
                <Highlighter
                    ...
                    searchWords={searchArray}
                    autoEscape
                    textToHighlight={props.data.name ? props.data.name.toString() : 'NAME MISSING'}
                />
            </Title>
            {finishedProperties}
        </Card>
