...
This chart shows the distribution of terrestrial area of the habitats in the critterycovery database. Data: [critterycovery](http://critterycovery.me/api/habitats)`
)});
  main.variable(observer("chart")).define("chart", ["d3","width","height","color","bins","x","y","xAxis","yAxis"], function(d3,width,height,color,bins,x,y,xAxis,yAxis)
{
...
d3.bin().thresholds(40)(data)
  ...
  main.variable(observer("x")).define("x", ["d3","bins","margin","width"], function(d3,bins,margin,width){return(
d3.scaleLinear()
