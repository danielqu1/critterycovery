...
This chart shows the hierarchy of the regions, subregions, and countries in the critterycovery database. The size of each slice is determined by area (in square kilometers) of the corresponding region/subregion/country. Data: [critterycovery](http://critterycovery.me/api/species)

The zoomable sunburst diagram shows only two layers of the hierarchy at a time. Click a node to zoom in, or the center to zoom out.`
)});
...
FileAttachment("countries@1.json").json()
)});
